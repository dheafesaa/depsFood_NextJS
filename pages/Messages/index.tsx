      ...
      <div className="w-full flex items-center px-4 lg:px-8 bg-red-500 rounded-lg shadow py-8 lg:py-0">
        <div className="flex flex-col w-full lg:w-3/5">
          ...
          <Link
            ...
            className="max-full lg:max-w-xs inline-flex justify-center items-center p-2 text-base font-normal text-zinc-700 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100"
          >
            <svg
