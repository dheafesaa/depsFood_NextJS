        ...
        <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row">
          ...
          <div className="flex flex-col justify-between px-4 leading-normal max-w-2xl py-4">
            ...
            <p className="mb-2 font-normal text-justify text-zinc-500 indent-10">
              ...
              development, user interface design, HTML, and JavaScript. Beyond
              the technical skills, as frontend developer I have possesses a
              passion for creating aesthetically pleasing and user-centric
              experiences. I should keep up with the latest trends and best
              practices in frontend development, continuously expanding their
              knowledge and skills. Also strive for clean and maintainable code,
              optimizing performance and ensuring scalability.
            </p>
            <ul className="max-w-md space-y-1 text-zinc-500 list-inside">
